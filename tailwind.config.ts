  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'blob-1': 'blob-1 18s infinite ease-in-out',
        'blob-2': 'blob-2 22s infinite ease-in-out',
        'blob-3': 'blob-3 25s infinite ease-in-out',
        'blob-4': 'blob-4 15s infinite ease-in-out',
      },
    },
  },
